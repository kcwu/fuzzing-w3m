    ...
    with open('report.html', 'w') as report:
        ...
        for group in groups:
            for gi, case in enumerate(group['case']):
                ...
                report.write('</tr>')
        report.write('</table>')
        report.write("This table is generated by an automatical script without human analysis. Many false positives and false negatives due to limitation of my script.")
        report.write('Exit code: 99=valgrind detected errors.')
